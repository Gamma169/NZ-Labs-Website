    ...
    $.ajax({
      ...
      success: function(data, status, xhr) {
        ...
        if (redirect === false)
        {
		  ...
		  $('#success_message2').removeClass('u-hide');
          $('#success_message2').show();
		  $('#success_message3').removeClass('u-hide');
...
function errorSection(errorType) {
  return '<div class="' + msgErrClass + '" style="font-weight:bold; color:#ff6868;">' + localizedErrMap[errorType] + '</div>';
}